...
import com.cipl.meandmo.model.Orders;
import com.cipl.meandmo.model.Sort;
...
public class Constant {
    ...
    public static final String MyPREFERENCES = "com.cipl.meandmo"; // Add your package name

    public static final String PACKAGE_NAME = "com.cipl.meandmo";  // Add your package name

    public static final String DeepLinkDomain = "https://meandmo.page.link/mVFa";// Add your Deeplink Domain URL
    ...
    public static final String retailcustomer = "retail-customer";
