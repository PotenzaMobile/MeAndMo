package com.cipl.meandmo.helper;
...
import com.cipl.meandmo.utils.Debug;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String KEY_CSP_PRICE = "csp_price";
    ...
    private static final String CREATE_TABLE_CART = "CREATE TABLE "
            ...
            + KEY_PRODUCT_ID + " TEXT," +  KEY_CSP_PRICE + " TEXT," + KEY_QUANTITY + " INTEGER," + KEY_STOCK_QUANTITY + " INTEGER,"
...
//        db.execSQL("DROP TABLE IF EXISTS " + TABLE_REORDER);
    ...
    public String getVariationProductQuantityFromCart(Cart cart) {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                str = c.getString(c.getColumnIndex(KEY_QUANTITY));

            } while (c.moveToNext());

            Log.e("TAG", "getVariationProductQuantityFromCart: " + str);
...
//        Cursor c = db.rawQuery(selectQuery, null);
    ...
    public long addToCart(Cart cart) {
        if (cart.getBuyNow() == 1) {
            ...
            values.put(KEY_CSP_PRICE, cart.getCspPrice());
    ...
    public CategoryList getProductFromCartById(String product_id) {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                cart.setCspPrice((c.getString(c.getColumnIndex(KEY_CSP_PRICE))));
    ...
    //modification
    public int getProductvarationidFromCartById(String product_id) {
        SQLiteDatabase db = this.getReadableDatabase();
        ...
        Debug.e(LOG, selectQuery);
        Log.e("TAG", "getProductvarationidFromCartById: "+ selectQuery);
        Cursor c = db.rawQuery(selectQuery, null);
        ...
        if (c.moveToFirst()) {
            do {
                ...
                Varationid = c.getInt(c.getColumnIndex(KEY_VARIATION_ID));
                Log.e("TAG", "getProductvarationidFromCartById: "+Varationid );
    ...
    public String getProductQuantity(String product_id) {
        ...
        Debug.e(LOG, selectQuery);
        Log.e("TAG", "getProductvarationidFromCartById:quantity "+ selectQuery);
        Cursor c = db.rawQuery(selectQuery, null);
        ...
        if (c.moveToFirst()) {
            do {
                ...
                quantity =  c.getInt(c.getColumnIndex(KEY_QUANTITY));
                Log.e("TAG", "getProductvarationidFromCartById:quantity"+quantity );
